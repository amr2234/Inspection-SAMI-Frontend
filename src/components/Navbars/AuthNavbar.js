...
export default function AuthNavbar(props) {
  ...
  let navbarBg = useColorModeValue(
    "linear-gradient(112.83deg, rgba(255, 255, 255, 0.4) 0%, rgba(255, 255, 255, 0.3) 110.84%)",
    "linear-gradient(112.83deg, rgba(255, 255, 255, 0.1) 0%, rgba(255, 255, 255, 0) 110.84%)"
  );
